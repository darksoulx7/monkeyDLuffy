const deleteDeviceFromDynamoDB = async (hardwareId, tableName, documentClient) => {
    try {
        ...
        throw new Error(`Error deleting from DynamoDB for hardwareId ${hardwareId}: ${err.message}`);
    }
};

module.exports = {
    deleteDeviceFromDynamoDB
}